...
const LoginTemplate=({logo,content, ...props })=>{
  return(
        <Wrapper {...props}> 
                                    {logo}
                                   ...
                                   <div id="Group_196_dg">
                                    ...
                                    <svg className="Rectangle_431_dl">
                                        <rect id="Rectangle_431_dl" rx="40" ry="40" x="0" y="0" width="1200px" height="550px">
                                        </rect>
                                    </svg>
