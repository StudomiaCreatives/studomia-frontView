...
#Dont_have_an_account_ {
	...
	font-weight: normal;
	font-size: 18px;
	color: rgba(42,50,242);//rgba(43,50,243,1);
	letter-spacing: 0.18px;
   
}

#Dont_have_an_account_:hover{
	opacity: 1;
}
 	...
 	render(){
              return(
						<Wrapper > 
										...
										<span>Create your <br/>Studomia account.</span>
										</div>
												...
												<div className="row omb_row-m-offset-3">
																		<div className="col-xs-12 col-sm-12">
																			<form className="omb_loginForm" action="" autocomplete="off" method="POST" width="500px" onSubmit={(e)=>this.handleSubmit(e)} >
																				...
																				<div className="input-group" style={{width: '500px'}}>
																					<span className="input-group-addon" style={{borderRadius:'20px 0px 0px 20px'}} ><i className="fa fa-lock fa-2x"></i></span>
																					<input  type="password" className="form-control"  placeholder="One more time?" style={{borderRadius:'0px 20px 20px 0px',height:'80px',fontSize:'20px'}} name="confirmPassword" onChange={(e)=>this.handleChange(e)}/>
																				</div>

																				<span className="help-block" style={{height:'30px'}} ></span>


																				<button className="btn btn-lg btn-primary btn-block" type="submit" style={{borderRadius:'20px',height:'80px',backgroundColor:'rgba(43,243,136,1)',border:'0px',width:'500px'}}>create my Account</button>
																			</form>
																		</div>
																		...
																		<div id="Dont_have_an_account_">
																		    <a href="/oauth2/authorize/google" className="" style={{color: 'rgba(42,50,242)',textDecoration:'none'}}>
														...
														<div id="Group_178">
																<svg class="Rectangle_440_fn">
																	<rect id="Rectangle_440_fn" rx="20" ry="20" x="0" y="0" width="560" height="70">
																	</rect>
																</svg>
																<div id="One_more_time_">
																	<span>One more time ?</span>
																</div>
																<svg class="Icon_map-locksmith_fp" viewBox="3.6 0.72 20 24">
																	<path id="Icon_map-locksmith_fp" d="M 22.68000221252441 10.72000122070312 L 21.60000419616699 10.72000122070312 L 21.60000419616699 6.404000282287598 C 21.60000419616699 3.565000534057617 18.75200271606445 0.7200000286102295 15.91300201416016 0.7200000286102295 L 11.17250061035156 0.7200000286102295 C 8.335000038146973 0.7200000286102295 5.600000381469727 3.565000534057617 5.600000381469727 6.404000282287598 L 5.600000381469727 10.72000122070312 L 4.40500020980835 10.72000122070312 C 4.066500186920166 10.72000122070312 3.599999904632568 11.25100135803223 3.599999904632568 11.5500020980835 L 3.599999904632568 24.27900123596191 C 3.599999904632568 24.5780029296875 4.066500186920166 24.72000122070312 4.40500020980835 24.72000122070312 L 22.68000221252441 24.72000122070312 C 23.01950263977051 24.72000122070312 23.60000228881836 24.5780029296875 23.60000228881836 24.27900123596191 L 23.60000228881836 11.5500020980835 C 23.60000228881836 11.25100231170654 23.01950073242188 10.72000217437744 22.68000221252441 10.72000217437744 Z M 15.95650196075439 22.72000312805176 L 11.13100051879883 22.72000312805176 L 12.14350128173828 17.73650360107422 C 11.53150081634521 17.30300331115723 11.13100051879883 16.48600387573242 11.13100051879883 15.68400382995605 C 11.13100051879883 14.36250305175781 12.211501121521 13.23700332641602 13.54350090026855 13.23700332641602 C 14.87550067901611 13.23700332641602 15.95650196075439 14.28150367736816 15.95650196075439 15.60200309753418 C 15.95650196075439 16.40450286865234 15.55600166320801 17.31650161743164 14.94500160217285 17.75050163269043 L 15.95650196075439 22.72000312805176 Z M 18.10000228881836 10.72000122070312 L 9.100000381469727 10.72000122070312 L 9.100000381469727 6.404000282287598 C 9.100000381469727 5.115000247955322 9.946500778198242 4.220000267028809 11.22050094604492 4.220000267028809 L 15.8650016784668 4.220000267028809 C 17.13900375366211 4.220000267028809 18.10000228881836 5.115000247955322 18.10000228881836 6.404000282287598 L 18.10000228881836 10.72000122070312 Z">
																	</path>
																</svg>
														</div>
											...
											*/}
											...
											<div id="Group_193">
														<div id="Group_190">
															...
															<svg class="Icon_awesome-google" viewBox="0 0.563 34.313 34.875">
																...
																<a href="/oauth2/authorize/google" className="btn btn-lg btn-primary btn-block Rectangle_433" style={{borderRadius:'20px',height:'70px',backgroundColor:'rgba(243,169,43,1)',border:'0px',width:'260px',cursor:'pointer',zIndex :'1'}}>
														...
														<div id="Group_191">
															...
															<svg class="Icon_simple-facebook" viewBox="0 0 38 37.769">
															...
															<a href="/oauth2/authorize/facebook" className="btn btn-lg btn-primary btn-block Rectangle_433_ef" style={{borderRadius:'20px',height:'70px',backgroundColor:'rgba(43,50,243,1)',border:'0px',width:'260px',cursor:'pointer',zIndex :'1'}}>
