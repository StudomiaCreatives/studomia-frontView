...
import styled from 'styled-components'
 ...
 const GenderWrapper=styled.div`
      display:flex;
 `
export default class  ExpertRegForm extends Component
 {
    ...
    render() {
             ...
             return(
                       <Wrapper>
                                  <Caption> Expert Reg.</Caption>
                            {this.state.submitted ? (
                                                <div>
                                                    <h4>You submitted successfully!</h4>
                                                    {/* <Modal title="You submitted successfully!" closeable="true" onClose={this.clear}/> */}
                                ...
                                (
                                                ...
                                                <FormLayout>
                                                    ...
                                                    <FormGroup className="form-group">
                                                            <Field placeholder="Specialty:" name="specialty" type="text" id="specialty"
                                                              required value={this.state.specialty} onChange={this.onChangeSpecialty}/>
